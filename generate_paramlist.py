...
def main():
    ...
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['entrainment_factor'] = 0.16
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['detrainment_factor'] = 0.5
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['turbulent_entrainment_factor'] = 0.1
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['sorting_power'] = 6.0
    ...
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['pressure_normalmode_drag_coeff'] = 5.0
