...
def main():
    ...
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['tke_diss_coeff'] = 0.29# 0.22
    ...
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['entrainment_factor'] = 0.11
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['detrainment_factor'] = 0.52
